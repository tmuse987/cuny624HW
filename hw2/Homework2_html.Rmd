...
<div id="Question_6.3.png"><img src="Question_6.3.png" alt="Question_6.3.png"></div>
```{r}
```

##### <span style="color:blue"><b><u>KJ# 7.2</u></b></span>
<div id="Question_7.2_Part1.png"><img src="Question_7.2_Part1.png" alt="Question_7.2_Part1.png"></div>
<div id="Question_7.2_Part2.png"><img src="Question_7.2_Part2.png" alt="Question_7.2_Part2.png"></div>
...
```{r}
fried_knn_pred  = predict(fried_knn, testData$x)
fried_mars_pred = predict(fried_mars, testData$x)
fried_svm_pred  = predict(fried_svm, testData$x)

fried_knn_perf  = defaultSummary(data.frame(obs = testData$y, pred = fried_knn_pred))
fried_mars_perf = defaultSummary(data.frame(obs = testData$y, pred = fried_mars_pred[, 1]))
fried_svm_perf  = defaultSummary(data.frame(obs = testData$y, pred = fried_svm_pred))
...
<div id="Question_7.5.png"><img src="Question_7.5.png" alt="Question_7.5.png"></div>
```{r}
```

##### <span style="color:blue"><b><u>KJ# 8.1</u></b></span>
<div id="Question_8.1_Part1.png"><img src="Question_8.1_Part1.png" alt="Question_8.1_Part1.png"></div>
<div id="Question_8.1_Part2.png"><img src="Question_8.1_Part2.png" alt="Question_8.1_Part2.png"></div>
```{r}
```

##### <span style="color:blue"><b><u>KJ# 8.2</u></b></span>
<div id="Question_8.2.png"><img src="Question_8.2.png" alt="Question_8.2.png"></div>
```{r}
```

##### <span style="color:blue"><b><u>KJ# 8.3</u></b></span>
<div id="Question_8.3.png"><img src="Question_8.3.png" alt="Question_8.3.png"></div>
```{r}
```

##### <span style="color:blue"><b><u>KJ# 8.7</u></b></span>
<div id="Question_8.7.png"><img src="Question_8.7.png" alt="Question_8.7.png"></div>
```{r}
```
