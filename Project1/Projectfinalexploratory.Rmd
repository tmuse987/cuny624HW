...
We are using here difference of each value over previous value and logarithm transformation for Var02
...
p4 <- plot(log(group_S01_df$Var02), type = "l", main = "LogdataS01&Var02")
p5 <- plot(group_S02_df$Var02, type = "l", main = "original dataS02&Var02")
p6 <- plot(log(group_S02_df$Var02), type = "l", main = "LogdataS02&Var02")
...
p16 <- plot(log(group_S04_df$Var02), type = "l", main = "LogdataS04&Var02")
